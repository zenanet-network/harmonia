...
import (
	...
	chainTypes "github.com/zenanet-network/harmonia/chainmanager/types"
)
...
type chainManager struct {
	...
	ZenaChainConfirmation int `json:"zenachain_tx_confirmations"`
...
type ContractAddresses struct {
	...
	ZenaChainAddress      string `json:"zena_token_address"`
