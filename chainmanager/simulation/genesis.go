...
const (
	...
	ZenachainTxConfirmations = "Zenachain_tx_confirmations"

	EireneChainID            = "eirene_chain_id"
	ZenaTokenAddress     = "zena_token_address"     //nolint
...
func RandomizedGenState(simState *module.SimulationState) {
	...
	simState.AppParams.GetOrGenerate(simState.Cdc, ZenachainTxConfirmations, &maticchainTxConfirmations, simState.Rand,
		func(r *rand.Rand) { maticchainTxConfirmations = GenMaticchainTxConfirmations(r) },
	)

	simState.AppParams.GetOrGenerate(simState.Cdc, EireneChainID, &borChainID, simState.Rand,
