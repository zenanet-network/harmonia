...
import (
	...
	"github.com/zenanet-network/harmonia/file"
	"github.com/zenanet-network/harmonia/version"

	"github.com/zenanet-network/harmonia/app"
	authCli "github.com/zenanet-network/harmonia/auth/client/cli"
	hmTxCli "github.com/zenanet-network/harmonia/client/tx"
	"github.com/zenanet-network/harmonia/helper"
)

var logger = helper.Logger.With("module", "cmd/harmoniacli")

// rootCmd is the entry point for this binary
var (
	rootCmd = &cobra.Command{
		Use:   "harmoniacli",
		Short: "Harmonia light-client",
