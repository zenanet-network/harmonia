...
import (
	...
	restClient "github.com/zenanet-network/harmonia/client/rest"
	"github.com/zenanet-network/harmonia/types"
	"github.com/zenanet-network/harmonia/types/rest"
)
...
func SendRequestHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// get to address
		toAddr := types.HexToHarmoniaAddress(vars["address"])
		...
		// get from address
		fromAddr := types.HexToHarmoniaAddress(req.BaseReq.From)
