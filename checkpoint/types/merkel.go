...
func ValidateCheckpoint(start uint64, end uint64, rootHash hmTypes.HarmoniaHash, checkpointLength uint64, contractCaller helper.IContractCaller, confirmations uint64) (bool, error) {
...
func GetAccountProof(dividendAccounts []hmTypes.DividendAccount, userAddr hmTypes.HarmoniaAddress) ([]byte, uint64, error) {
...
func VerifyAccountProof(dividendAccounts []hmTypes.DividendAccount, userAddr hmTypes.HarmoniaAddress, proofToVerify string) (bool, error) {
