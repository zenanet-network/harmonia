...
type ZenaChainListener struct {
	BaseListener
}

// NewMaticChainListener - constructor func
func NewMaticChainListener() *ZenaChainListener {
	return &ZenaChainListener{}
}

// Start starts new block subscription
func (ml *ZenaChainListener) Start() error {
...
func (ml *ZenaChainListener) ProcessHeader(newHeader *blockHeader) {
...
func (ml *ZenaChainListener) sendTaskWithDelay(taskName string, headerBytes []byte, delay time.Duration) {
